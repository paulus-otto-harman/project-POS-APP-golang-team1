...
type Category struct {
	...
	Icon        string    `gorm:"size:255;not null" json:"icon" binding:"omitempty" example:"/icon/category.png"`
	Name        string    `gorm:"size:100;unique" json:"name" form:"name"`
	Description string    `gorm:"type:text" example:"lorem" json:"description" form:"description"`
