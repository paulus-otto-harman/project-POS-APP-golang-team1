...
type Product struct {
	...
	CategoryID   int        `gorm:"not null" json:"-" binding:"omitempty,gt=0" form:"category_id" example:"1"`
	...
	Stock        int        `gorm:"not null" binding:"omitempty,gt=0" json:"stock" form:"stock" example:"50"`
