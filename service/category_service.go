...
type CategoryService interface {
	...
	AllProducts(page, limit int, categoryID string) ([]*domain.ProductDetail, int64, error)
}
...
func (s *categoryService) AllProducts(page, limit int, categoryID string) ([]*domain.ProductDetail, int64, error) {
